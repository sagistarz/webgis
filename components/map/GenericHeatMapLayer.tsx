...
// // // // // //       if (!feature.geometry) {
// // // // // //         console.log(`DEBUG: Melewati fitur ${index}: Geometri tidak valid`);
// // // // // //         return;
// // // // // //       }
// // // // // //       try {
...
// // // // // //     console.log("DEBUG: getTooltipContent - kelurahan:", kelurahanName, "value:", formattedValue);
// // // // // //     return `
...
// // // // // //   // Type guard untuk memastikan geometri adalah Polygon atau MultiPolygon
...
// // // // // //   // Debounce handler untuk mousemove
// // // // // //   const handleMouseMove = useCallback(
// // // // // //     debounce((e: L.LeafletMouseEvent) => {
// // // // // //       if (!map || !boundaryData || !spatialIndexRef.current) {
...
// // // // // //       // Pastikan kursor berada dalam batas kelurahan
// // // // // //       const point = turf.point([e.latlng.lng, e.latlng.lat]);
// // // // // //       const isInside = boundaryData.features.some((f: BoundaryFeature) => {
// // // // // //         if (!isPolygonOrMultiPolygonFeature(f)) return false;
// // // // // //         try {
...
// // // // // //       // Cari fitur kelurahan yang sesuai
...
// // // // // //         if (!isPolygonOrMultiPolygonFeature(feature)) return false;
// // // // // //         try {
...
// // // // // //       // Cari data nilai mentah (aod atau pm25) dari geoData.features
// // // // // //       const dataFeature = geoData?.features.find((f: GeoJSONTypes.Feature<GeoJSONTypes.Point | GeoJSONTypes.Polygon | GeoJSONTypes.MultiPolygon, { aod_value?: number; pm25_value?: number }>) => {
// // // // // //         if (!isPolygonOrMultiPolygonFeature(f)) return false;
// // // // // //         try {
// // // // // //           return turf.booleanPointInPolygon(point, f);
// // // // // //         } catch {
...
// // // // // //           .addTo(map);
// // // // // //       }
// // // // // //     }, 100), // Debounce dengan delay 100ms
// // // // // //     [map, boundaryData, geoData, dataType]
// // // // // //   );
...
// // // // // //         console.log("DEBUG: Removed existing ImageOverlay due to missing data or loading");
// // // // // //       }
// // // // // //       if (tooltipRef.current) {
// // // // // //         tooltipRef.current.remove();
// // // // // //         tooltipRef.current = null;
...
// // // // // //     }
// // // // // //   }, [map, cachedGrid, geoData, boundaryData, isLoading, dataType, handleMouseMove]);
...
// // // // //       const validBoundaryFeatures = boundaryData.features.filter(
// // // // //         (f: BoundaryFeature): f is GeoJSONTypes.Feature<GeoJSONTypes.Polygon | GeoJSONTypes.MultiPolygon, any> =>
...
// // // // //       // Filter boundaryData.features untuk hanya menyertakan Polygon atau MultiPolygon
// // // // //       const validBoundaryFeatures = boundaryData.features.filter(isPolygonOrMultiPolygonFeature);

// // // // //       // Pastikan kursor berada dalam batas kelurahan
// // // // //       const point = turf.point([e.latlng.lng, e.latlng.lat]);
// // // // //       const isInside = validBoundaryFeatures.some((f) => {
// // // // //         try {
// // // // //           return turf.booleanPointInPolygon(point, f);
// // // // //         } catch {
// // // // //           return false;
...
// // // // //       // Filter geoData.features untuk hanya menyertakan Polygon atau MultiPolygon
// // // // //       const validGeoDataFeatures = geoData?.features.filter(isPolygonOrMultiPolygonFeature) || [];

// // // // //       // Cari data nilai mentah (aod atau pm25) dari validGeoDataFeatures
...
// // // //   // Type guard untuk memastikan geometri adalah Polygon atau MultiPolygon
// // // //   const isPolygonOrMultiPolygonFeature = (feature: GeoJSONTypes.Feature<GeoJSONTypes.Geometry, any>): feature is GeoJSONTypes.Feature<GeoJSONTypes.Polygon | GeoJSONTypes.MultiPolygon, any> => {
// // // //     return !!feature.geometry && (feature.geometry.type === "Polygon" || feature.geometry.type === "MultiPolygon");
// // // //   };
...
// // //       const isInside = boundaryData.features.some((f: BoundaryFeature) => {
// // //         try {
// // //           return turf.booleanPointInPolygon(point, f as GeoJSONTypes.Feature<GeoJSONTypes.Polygon | GeoJSONTypes.MultiPolygon>);
// // //         } catch {
// // //           return false;
// // //         }
// // //       });
...
// // //         const feature = boundaryData.features[item.featureIndex];
// // //         try {
// // //           return turf.booleanPointInPolygon(point, feature as GeoJSONTypes.Feature<GeoJSONTypes.Polygon | GeoJSONTypes.MultiPolygon>);
// // //         } catch {
// // //           return false;
// // //         }
// // //       })?.featureIndex;
...
const GenericHeatMapLayer: React.FC<HeatMapLayerProps> = ({
  ...
  const cachedBoundaries = useMemo(() => {
    ...
    const validFeatures = geoData.features
      ...
      .filter((f): f is GeoJSONTypes.Feature<GeoJSONTypes.Polygon | GeoJSONTypes.MultiPolygon> => f != null);
    console.log("DEBUG: cachedBoundaries - Jumlah fitur valid:", validFeatures.length);
    return turf.featureCollection(validFeatures as GeoJSONTypes.Feature<GeoJSONTypes.Polygon | GeoJSONTypes.MultiPolygon>[]);
  }, [geoData, dataType]);
  ...
  const generateStaticGrid = useCallback(
    (geoData: GeoJSONData, boundaryData: BoundaryGeoJSONData) => {
      ...
      grid.features.forEach((feature) => {
        ...
        const point = turf.point(coords as [number, number]);
        const inBuffer = cachedBoundaries.features.some((buffer: GeoJSONTypes.Feature<GeoJSONTypes.Polygon | GeoJSONTypes.MultiPolygon>) => {
          try {
            return turf.booleanPointInPolygon(point, buffer.geometry);
          } catch {
            return false;
