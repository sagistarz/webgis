...
// //         // Gunakan tipe GeoJSON.Feature
// //         const validFeatures = data.features.filter((f: GeoJSON.Feature<GeoJSON.Point, { aod_value?: number; pm25_value?: number }>) => {
...
// //         console.log("boundaryData structure:", JSON.stringify(boundaryData, null, 2)); // Tambahkan log
