...
// //       }
// //     });
// //   }, [selectedDate, selectedStation, fetchWeatherData, formatLocalDate]); // Tambahkan formatLocalDate ke dependensi
...
// //   }, [currentMonth, currentYear, getPM25Value, getDaysInMonth, getFirstDayOfMonth]);
...
// //                           <div className={styles.indikatorPM} style={{ backgroundColor: interpolatePM25Color(dayData.pm25) }}>
...
//   showRightPanel?: boolean;
//   splitViewContainer?: string;
//   onStationChange?: (stationName: string) => void; // Tambahkan prop onStationChange
// }
...
//   showRightPanel = true,
//   splitViewContainer,
//   onStationChange, // Tambahkan ke destructure props
// }) => {
//   const [currentMonth, setCurrentMonth] = useState(new Date().getMonth());
//   const [currentYear, setCurrentYear] = useState(new Date().getFullYear());
//   const [pm25Data, setPM25Data] = useState<PM25Data[]>([]);
